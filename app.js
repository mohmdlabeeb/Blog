...
app.get('/',function(req,res){
  const find = post.find({},function(err,found){
if(!err)
{
  res.render("home",{content:homeStartingContent, post:found});
}
else
{
  console.log(error);
  ...
  // res.render("home",{content:homeStartingContent, post:postArray});
});
